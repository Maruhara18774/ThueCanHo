...
VALUES	('CANHOSUNFLOWER','PHONG CHINH',1,2,'1','5','0',10,5,'1','none'),
		('CANHOSUNFLOWER','PHONG KHACH',2,7,'0','5','1',10,5,'1','none'),
		('CANHOSUNFLOWER','PHONG VE SINH',1,7,'0','5','1',10,5,'1','none'),
		('CANHOSUNFLOWER','PHONG BEP',2,7,'0','1','0',10,5,'1','none');

--phong nha 2
INSERT INTO PHONG(ID_NHA,TEN_PHONG,ID_LOAIPHONG,ID_LOAIGIUONG,SOGIUONG,SONGUOITOIDA,SOGIUONG_PHU,CHIEUDAI_PHONG,CHIEURONG_PHONG,SOLUONG,MOTA)
VALUES	('HAKAYAMACH1','PHONG CHINH',1,3,'2','5','1',10,5,1,'none'),
		('HAKAYAMACH1','PHONG KHACH',2,7,'0','5',1,10,5,'1','none'),
		('HAKAYAMACH1','PHONG VE SINH',1,7,'0','5',0,10,5,'1','none'),
		('HAKAYAMACH1','PHONG BEP',2,7,'0','1','0',10,5,'1','none');
