...
CREATE TABLE TAIKHOANHETHONG(
	ID_TAIKHOAN_HT NVARCHAR(50) PRIMARY KEY,
	TEN_TAIKHOAN_HT VARCHAR(100) UNIQUE,
	MATKHAU VARCHAR(100),
	ROLE_TAIKHOAN_HT VARCHAR(50)
)
...
CREATE TABLE DANHGIA(
	...
	SOSAO SMALLINT,
	NOIDUNG TEXT,
	CONSTRAINT FK_DANHGIA_THONGTINKHACHHANG FOREIGN KEY(ID_TT_KHACHHANG) REFERENCES THONGTINKHACHHANG (ID_TT_KHACHHANG),
...
CREATE TABLE PAYPALSAVED(
    ID_SAVED INT IDENTITY(1,1) PRIMARY KEY,
    ID_PAYMENT INT,
    ID_TRANSACTION VARCHAR(MAX),
    CONSTRAINT FK_PAYPALSAVED_DATCANHO FOREIGN KEY(ID_PAYMENT) REFERENCES DATCANHO (ID_DATCANHO),
)
